    ...
    return (
      <AuthLayout title="Password reset" subtitle="Your password has been changed successfully">
        <div className="flex flex-col items-center gap-5 rounded-2xl border bg-card p-8 text-center shadow-sm">
          ...
          <div className="flex items-center gap-2 rounded-xl bg-muted/50 px-4 py-3 text-sm text-muted-foreground w-full justify-center">
            <span>Redirecting to sign in in</span>
            <span className="tabular-nums font-bold text-foreground w-4 text-center">{countdown}</span>
