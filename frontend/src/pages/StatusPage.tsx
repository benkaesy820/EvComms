...
import { Clock, XCircle, ShieldOff, LogOut, RefreshCw, Mail, MessageSquare } from 'lucide-react'
...
export function StatusPage() {
  ...
  const supportEmail = configData?.brand?.supportEmail
              ...
              <div className="flex gap-2 w-full">
                {supportEmail ? (
                  <a
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-2 h-10 rounded-xl border text-sm font-medium bg-background hover:bg-muted transition-colors"
                  >
