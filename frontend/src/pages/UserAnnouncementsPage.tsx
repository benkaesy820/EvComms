...
import {
  usePublicAnnouncements, useVoteAnnouncement, useAnnouncementSocket,
...
// Inline renderer — strips <p> wrapper so line-clamp works correctly
...
function AnnouncementCard({
  ...
  return (
    <div
      className={cn(
        'rounded-xl border overflow-hidden transition-all hover:shadow-lg cursor-pointer',
          ...
          <div className="p-4">
            ...
            <div className="flex items-center justify-between mt-4 pt-3 border-t">
              ...
              <div className="flex items-center gap-3 text-[11px] text-muted-foreground">
                ...
                <button
                  onClick={(e) => { e.stopPropagation(); onView(announcement.id) }}
...
export function UserAnnouncementsPage() {
  ...
  // Subscribe to real-time vote/reaction updates for the list
    ...
    return (
      <div className="flex flex-col items-center justify-center gap-4 text-muted-foreground p-8 min-h-[300px]">
        ...
        <div className="text-center">
          ...
          <p className="text-sm mt-1">There was an error loading the announcements. Please try again.</p>
        </div>
        <Button variant="outline" className="gap-2 rounded-xl" onClick={() => { queryClient.invalidateQueries({ queryKey: ['announcements'] }) }}>
