...
const NAV_ITEMS: NavItem[] = [
  ...
  { path: '/home/reports', icon: FileWarning, label: 'Reports', exact: false },
...
export function UserLayout() {
  ...
  // Suppress badge when user is actively on the chat page — no flash
  const isOnChatPage = location.pathname.startsWith('/home/chat')
  const unreadCount = isOnChatPage ? 0 : (conversationData?.conversation?.unreadCount ?? 0)
