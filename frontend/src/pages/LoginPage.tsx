    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="space-y-1.5">
          ...
          />
          {errors.email && (
            <p id="email-error" className="text-xs text-destructive pl-1" role="alert">{errors.email.message}</p>
          )}
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <PasswordInput
            ...
            />
          {errors.password && (
            <p id="password-error" className="text-xs text-destructive pl-1" role="alert">{errors.password.message}</p>
          )}
        </div>
