      ...
      <div className="flex flex-col gap-1">
        {options.map((option) => (
          <button
            ...
            className="flex items-center gap-3 px-2 py-3 rounded-xl hover:bg-muted transition-colors group text-left w-full min-h-[52px]"
          >
            <div className={cn(
              'w-10 h-10 rounded-xl flex items-center justify-center text-white shadow-sm flex-shrink-0 transition-transform duration-200 group-hover:scale-105',
              option.color
            )}>
