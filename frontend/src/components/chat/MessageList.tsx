...
export function MessageList<T>({
    ...
    const sortedMessages = useMemo(() => {
        ...
        // Cap DOM to maxRenderedPages * 50 messages (approx page size).
        // When the user has loaded many pages, discard the oldest ones from the DOM.
        // This prevents unbounded DOM growth without breaking the infinite scroll UX.
        const pageSize = 50
