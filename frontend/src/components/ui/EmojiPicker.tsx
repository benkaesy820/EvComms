...
<button
            ...
            {/* Emoji grid */}
            <div className="overflow-y-auto max-h-48 sm:max-h-48 p-1.5 custom-scrollbar">
                    ...
                    <div className="grid grid-cols-8 gap-0.5">
                        {visibleEmojis.map((entry) => (
                            <button
                                ...
                                title={entry.name}
                                className={cn(
                                    'flex items-center justify-center h-9 w-9 rounded-lg text-lg transition-all hover:scale-110 hover:bg-accent active:scale-95',
