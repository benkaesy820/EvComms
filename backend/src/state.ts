...
class StateManager {
  ...
  updateUserCache(userId: string, updates: Partial<CachedUser>): void {
  ...
  invalidateUsersByStatus(status: string): void {
    let count = 0
  ...
  invalidateSessionCache(userId: string, sessionId: string): void {
    const key = `${userId}:${sessionId}`
...
export const updateUserCache = (userId: string, updates: Partial<CachedUser>) => serverState.updateUserCache(userId, updates)
export const removeUserFromCache = (userId: string) => serverState.removeUserFromCache(userId)
export const invalidateUsersByStatus = (status: string) => serverState.invalidateUsersByStatus(status)
...
export const invalidateSessionCache = (userId: string, sessionId: string) => serverState.invalidateSessionCache(userId, sessionId)
export const invalidateAllUserSessions = (userId: string) => serverState.invalidateAllUserSessions(userId)
