...
--> statement-breakpoint
CREATE INDEX `idx_sessions_priority` ON `sessions` (`user_id`,`priority`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_refresh_active` ON `refresh_tokens` (`user_id`,`revoked_at`,`expires_at`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_media_pending_upload` ON `media` (`status`,`uploaded_at`) WHERE "media"."status" = 'pending';
--> statement-breakpoint
CREATE INDEX `idx_media_hash` ON `media` (`hash`) WHERE "media"."hash" IS NOT NULL;
...
--> statement-breakpoint
CREATE INDEX `idx_reg_reports_status_created` ON `registration_reports` (`status`,`created_at`);
--> statement-breakpoint
CREATE INDEX `idx_reg_reports_user` ON `registration_reports` (`user_id`);
--> statement-breakpoint
CREATE INDEX `idx_reg_reports_reviewed_by` ON `registration_reports` (`reviewed_by`);
...
--> statement-breakpoint
CREATE INDEX `idx_conversations_admin_unread` ON `conversations` (`admin_unread_count`,`last_message_at`);
--> statement-breakpoint
CREATE INDEX `idx_conversations_last_message` ON `conversations` (`last_message_at`);
--> statement-breakpoint
CREATE INDEX `idx_conversations_assigned_admin` ON `conversations` (`assigned_admin_id`,`archived_at`,`last_message_at`);
--> statement-breakpoint
CREATE INDEX `idx_conversations_user` ON `conversations` (`user_id`);
--> statement-breakpoint
CREATE INDEX `idx_conversations_archived` ON `conversations` (`archived_at`);
--> statement-breakpoint
CREATE INDEX `idx_conversations_archived_by` ON `conversations` (`archived_by`);
--> statement-breakpoint
CREATE INDEX `idx_conversations_active` ON `conversations` (`deleted_at`,`archived_at`,`last_message_at`);
...
--> statement-breakpoint
CREATE INDEX `idx_announcements_public_active` ON `announcements` (`is_public`,`is_active`,`created_at`);
--> statement-breakpoint
CREATE INDEX `idx_announcements_created_by` ON `announcements` (`created_by`);
--> statement-breakpoint
CREATE INDEX `idx_announcements_expires` ON `announcements` (`expires_at`) WHERE "announcements"."expires_at" IS NOT NULL;
...
--> statement-breakpoint
CREATE INDEX `idx_messages_conv_created` ON `messages` (`conversation_id`,`created_at`) WHERE "messages"."deleted_at" IS NULL;
--> statement-breakpoint
CREATE INDEX `idx_messages_conv_unread` ON `messages` (`conversation_id`,`status`,`deleted_at`) WHERE "messages"."deleted_at" IS NULL;
--> statement-breakpoint
CREATE INDEX `idx_messages_sender_created` ON `messages` (`sender_id`,`created_at`);
--> statement-breakpoint
CREATE INDEX `idx_messages_reply_to` ON `messages` (`reply_to_id`) WHERE "messages"."reply_to_id" IS NOT NULL;
--> statement-breakpoint
CREATE INDEX `idx_messages_media_id` ON `messages` (`media_id`) WHERE "messages"."media_id" IS NOT NULL;
...
--> statement-breakpoint
CREATE INDEX `idx_ann_comments_created` ON `announcement_comments` (`announcement_id`,`created_at`);
...
--> statement-breakpoint
CREATE UNIQUE INDEX `uq_announcement_vote` ON `announcement_votes` (`announcement_id`,`user_id`);
...
--> statement-breakpoint
CREATE INDEX `idx_status_history_user_created` ON `user_status_history` (`user_id`,`created_at`);
--> statement-breakpoint
CREATE INDEX `idx_status_history_changed_by` ON `user_status_history` (`changed_by`);
...
--> statement-breakpoint
CREATE INDEX `idx_user_reports_resolver` ON `user_reports` (`resolved_by`);
...
--> statement-breakpoint
CREATE INDEX `idx_internal_messages_reply_to` ON `internal_messages` (`reply_to_id`) WHERE "internal_messages"."reply_to_id" IS NOT NULL;
...
--> statement-breakpoint
CREATE INDEX `idx_internal_reactions_message` ON `internal_message_reactions` (`message_id`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_internal_reads_unread` ON `internal_message_reads` (`unread_count`) WHERE "internal_message_reads"."unread_count" > 0;
--> statement-breakpoint
CREATE UNIQUE INDEX `uq_internal_reads_user` ON `internal_message_reads` (`user_id`);
...
--> statement-breakpoint
CREATE INDEX `idx_dm_thread_fwd` ON `direct_messages` (`sender_id`,`recipient_id`,`created_at`);
--> statement-breakpoint
CREATE INDEX `idx_dm_thread_rev` ON `direct_messages` (`recipient_id`,`sender_id`,`created_at`);
--> statement-breakpoint
CREATE INDEX `idx_dm_recipient_created` ON `direct_messages` (`recipient_id`,`created_at`);
--> statement-breakpoint
CREATE INDEX `idx_dm_reply_to` ON `direct_messages` (`reply_to_id`) WHERE "direct_messages"."reply_to_id" IS NOT NULL;
...
--> statement-breakpoint
CREATE INDEX `idx_dm_status_user` ON `dm_recipient_status` (`user_id`);
--> statement-breakpoint
CREATE INDEX `idx_dm_status_unread` ON `dm_recipient_status` (`user_id`,`unread_count`) WHERE "dm_recipient_status"."unread_count" > 0;
--> statement-breakpoint
CREATE UNIQUE INDEX `uq_dm_status` ON `dm_recipient_status` (`user_id`,`partner_id`);
